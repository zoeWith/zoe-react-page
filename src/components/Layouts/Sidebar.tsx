                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/apps/todolist" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">todo_list</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/apps/notes" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">notes</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/apps/scrumboard" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">scrumboard</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                    ...
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'invoice' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('invoice')}>
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">invoice</span>
                                            </div>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'invoice' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <NavLink to="/apps/invoice/list">list</NavLink>
                                                </li>
                                                <li>
                                                    <NavLink to="/apps/invoice/preview">preview</NavLink>
                                                </li>
                                                <li>
                                                    <NavLink to="/apps/invoice/add">add</NavLink>
                                                </li>
                                                <li>
                                                    <NavLink to="/apps/invoice/edit">edit</NavLink>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'component' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('component')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">components</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'component' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/components/accordions">accordions</NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <NavLink to="/components/countdown">countdown</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/counter">counter</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/sweetalert">sweet_alerts</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/timeline">timeline</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/notifications">notifications</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/media-object">media_object</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/list-group">list_group</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/pricing-table">pricing_tables</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/lightbox">lightbox</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'element' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('element')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">elements</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'element' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/elements/alerts">alerts</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/avatar">avatar</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/badges">badges</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/breadcrumbs">breadcrumbs</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/buttons">buttons</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/buttons-group">button_groups</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/color-library">color_library</NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <NavLink to="/elements/jumbotron">jumbotron</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/loader">loader</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/pagination">pagination</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/popovers">popovers</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/progress-bar">progress_bar</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/search">search</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/tooltips">tooltips</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/treeview">treeview</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/typography">typography</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/font-icons" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">font_icons</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/dragndrop" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">drag_and_drop</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/tables" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">tables</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'datalabel' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('datalabel')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">datatables</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'datalabel' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/datatables/basic">basic</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/advanced">advanced</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/skin">skin</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/order-sorting">order_sorting</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/multi-column">multi_column</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/multiple-tables">multiple_tables</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/alt-pagination">alt_pagination</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/checkbox">checkbox</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/range-search">range_search</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/export">export</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/datatables/column-chooser">column_chooser</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'forms' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/forms/basic">basic</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/input-group">input_group</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/layouts">layouts</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/validation">validation</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/input-mask">input_mask</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/select2">select2</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/touchspin">touchspin</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/checkbox-radio">checkbox_and_radio</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/switches">switches</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/wizards">wizards</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/file-upload">file_upload</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/quill-editor">quill_editor</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/markdown-editor">markdown_editor</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/date-picker">date_and_range_picker</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/forms/clipboard">clipboard</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'users' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/users/user-account-settings">account_settings</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'page' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('page')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">pages</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'page' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/pages/knowledge-base">knowledge_base</NavLink>
                                        </li>
                                        <li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'auth' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('auth')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">authentication</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="https://vristo.sbthemes.com" target="_blank" className="nav-link group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">documentation</span>
                                    </div>
                                </NavLink>
                            </li>
                        </ul>
