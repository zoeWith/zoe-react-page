        ...
        <header className="z-40">
            <div className="shadow-sm">
                <div className="relative bg-white flex w-full items-center px-5 py-2.5">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-8 ltr:-ml-1 inline" src="/assets/images/logo.svg" alt="logo" />
                            <span className="text-2xl ltr:ml-1.5 font-semibold align-middle hidden md:inline transition-all duration-300">VRISTO</span>
                        </Link>
                        <button
                            type="button"
                            className="collapse-icon flex-none hover:text-primary flex lg:hidden ltr:ml-2 p-2 rounded-full bg-white-light/40 hover:bg-white-light/90"
                            onClick={() => {
                        ...
                        <div className="sm:ltr:mr-auto">
                            ...
                            >
                                <div className="relative">
                                    <input type="text" className="form-input ltr:pl-9 ltr:sm:pr-4 ltr:pr-9 peer sm:bg-transparent bg-gray-100 placeholder:tracking-widest" placeholder="Search..." />
                                    <button type="button" className="absolute w-9 h-9 inset-0 ltr:right-auto appearance-none peer-focus:text-primary">
                                        <svg className="mx-auto" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="11.5" cy="11.5" r="9.5" stroke="currentColor" strokeWidth="1.5" opacity="0.5" />
                                            <path d="M18.5 18.5L22 22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                                        </svg>
                                    </button>
                                    <button type="button" className="hover:opacity-80 sm:hidden block absolute top-1/2 -translate-y-1/2 ltr:right-2" onClick={() => setSearch(false)}>
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Dropdown
                                ...
                                button={
                                    <span>
                                        ...
                                        <span className="flex absolute w-3 h-3 ltr:right-0 top-0">
                                            <span className="animate-ping absolute ltr:-left-[3px] -top-[3px] inline-flex h-full w-full rounded-full bg-success/50 opacity-75"></span>
                                                ...
                                                return (
                                                    <li key={notification.id} onClick={(e) => e.stopPropagation()}>
                                                        <div className="group flex items-center px-4 py-2">
                                                            ...
                                                            <div className="ltr:pl-3 flex flex-auto">
                                                                ...
                                                                <button
                                                                    type="button"
                                                                    className="ltr:ml-auto text-neutral-300 hover:text-danger opacity-0 group-hover:opacity-100"
                                ...
                                <ul className="text-dark !py-0 w-[230px] font-semibold">
                                        ...
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="ltr:pl-4 truncate">
                                                <h4 className="text-base">
                                                    Hee Jeong
                                                    <span className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2">Pro</span>
                                                </h4>
                                    ...
                                    <li>
                                        <Link to="/users/profile">
                                            <svg className="ltr:mr-2 shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li className="border-t border-white-light">
                                        <Link to="/auth/boxed-signin" className="text-danger !py-3">
                                            <svg className="ltr:mr-2 rotate-90 shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    opacity="0.5"
